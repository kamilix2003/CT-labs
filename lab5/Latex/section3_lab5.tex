...
\begin{document}
	...
	Parallel connection can be represented by sum of admittance characteristics, series connection by sum of impedance characteristics and chain connection by multiplication of chain or ABCD characteristics, also order of matrix multiplication is important,
